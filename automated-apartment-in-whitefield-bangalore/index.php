...
<html class="no-js" lang="">
   ...
   <head>
      ...
      <title>Buy a ready-to-move-in intelligent automated apartment in Whitefield Bangalore </title>
      <meta name="description" content="Buy an apartment at Ark Cloud City located in Whitefield Bangalore close to major offices and entertainment hubs. Get guaranteed rentals for minimum 18 months
         ">
      <meta name="keywords" content="Flats, apartments, Ark Cloud City, Whitefields, Bangalore, 8 months rental, but flat, ark group, 2-3 bhk, 2 bhk, 3 bhk, gated  community, smart homes, automated homes, compact homes, near marathalli, near varthur">
      <!-- Bootstrap -->
...
<!-- End Google Tag Manager (noscript) -->
       <header id="main-header">
         ...
         <div class="container">
            <div class="row">
              ...
              <!--   <div class="col-md-6 col-sm-6 col-xs-6 mobile-version">
                  <div class="pull-right">
                     <span id="contactNumber">
                      <a id="aa-waybeo_num" href="tel:8657079319" class="tel-num"> 

                         <span id="waybeo_num" style="visibility:hidden" > 
                        <img src="img/Cal-%20image.png" alt="Call-image" class="call-img">  <span class="click-to-call">Click to Call</span> </span> </a> </span>
      ...
      <div>
         <div id="main-content" class="main">
            <section class="main-section bg-blue mobile-bg">
               <div class="container">
               </div>
            </section>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-md-8 col-sm-12 banner_text">
                           <h1>Buy a Ready-to-move-in<br>Automated Apartment 
                              <br>with <mark style="background-color:#e31e25;color: #fff;padding: 0.1em 0.2em;margin:1%">18 months </mark> guaranteed rentals
                              <br>
                               <span><mark style="background-color:#1e5081;color: #fff;padding:10px;font-size:22px">In Whitefield</mark> </span>
                           </h1>
                        </div>
      ...
      <input type='text'  style='display:none;' name='actionType' value='TGVhZHM='></input>
                                       <input type='text' style='display:none;' name='returnURL' value='https://arkgroup.in/l/automated-apartment-in-whitefield-bangalore/thankyou.html' > </input>
                                       <br></br>
                                          ...
                                          <div class="row">
                                             ...
                                             <div class="col-sm-12">
                                                <div class="form-group">
                                                   ...
                                                   <input type='text' id="mobile" class="form-control phone" name='Mobile' id="Mobile" minlength="10" maxlength="10">
                                                </div>
                                             </div>
                                             <div style="display: none;">
      ...
      <option selected value='Not&#x20;Contacted'>Not Contacted</option>
         ...
         <option value='Not&#x20;Intrested'>Not Intrested</option>
                                            ...
                                            <input type="hidden" value="Submit">
                                             ...
                                             <div class="col-sm-12">
                                                <div class="form-group">
                                                   ...
                                                   <button onclick=" checkMandatory4415315000004067049(this)" id='formsubmit' type='submit' value='' class="btn btn-cta form-control"  >I want the 18 Months  Guaranteed <br> Rentals Offer</button> 
                                                </div>
                                             </div>
                                          </div>
                                       </div>
                                       <input type='hidden' name='eo' value='14f4ec16431e0686150daa43f3210513'/> <input type='hidden' name='te' value='true'/><img id='tr_img_d2f602bd7b8229d920a508285b1c34a59a17d89857143342f8a53fc1179a5362' src='https://crm.zohopublic.com/crm/WebFormAnalyticsServlet?rid=d2f602bd7b8229d920a508285b1c34a59a17d89857143342f8a53fc1179a5362gid4d01b37207b10f83458f8c6a291240f67451bbad6c560f1bf2a3951bf5ceb0bbgida378f81585080d3b6fb1acbec6638b71gid885e3c1045bd9bdcc91bdf30f82b5696gid14f4ec16431e0686150daa43f3210513' style='display: none;' /> 
                                    </form>
                                 </div>
                              </div>
                           </div>
            ...
            <div id="sldier-image" class="owl-carousel text-center" style="position:relative;z-index:9999">
               <div>
                  <img src="img/Gallery/01_gallery.jpg" class="img-responsive" alt="Pool">
                  <figcaption>Temperature-controlled swimming pool</figcaption>
               </div>
               <div>
                  <img src="img/Gallery/02_gallery.jpg" class="img-responsive" alt="clubhouse">
                  <figcaption>Clubhouse</figcaption>
               </div>
               <div>
                  <img src="img/Gallery/03_gallery.jpg" class="img-responsive" alt="Gym">
                  <figcaption> Gym </figcaption>
               </div>
               <div>
                  <img src="img/Gallery/04_gallery.jpg" class="img-responsive" alt="security">
                  <figcaption>Video surveillance for security</figcaption>
               </div>
               <div>
                  <img src="img/Gallery/05_gallery.jpg" class="img-responsive" alt="Dad">
                  <figcaption> Smart lighting systems </figcaption>
               </div>
               <div>
                  <img src="img/Gallery/06_gallery.jpg" class="img-responsive" alt="Video door">
                  <figcaption>Video door phone</figcaption>
               </div>
               <div>
                  <img src="img/Gallery/07_gallery.jpg" class="img-responsive" alt="Sensor-based lights">
                  <figcaption>Sensor-based lights for bathrooms</figcaption>
               </div>
            </div>
            ...
            <div class="item">
            <div class="wrapper">
            <img src="img/icon-01.jpg" alt="Happening" class="img-responsive" >
      ...
      <!-- <div class="visible-xs mobile-fixed">
         <a href="tel:6366782520" class="tel-num" style="color:#fff"><span class="glyphicon glyphicon-phone-alt"></span> +91 6366 7825 20</a>
         </div> -->
...
<script type="text/javascript">
    ...
    <!--   <script src="js/vendor/intlTelInput.min.js"></script> -->
     <!--  <script type="text/javascript" src="https://cdn.jsdelivr.net/jquery.slick/1.6.0/slick.min.js"></script>
      ...
      <script src="js/mainc619.js?v=1.0"></script>
      <!--<script type="text/javascript" src="js/sticky-sidebar.js"></script>-->
      <script async="" src="https://cdn.jsdelivr.net/jquery.validation/1.13.1/jquery.validate.min.js"></script>
      <script async src="https://cdn.jsdelivr.net/jquery.validation/1.13.1/additional-methods.min.js"></script>

      <script>
         $(document).ready(function() {         
          var owl = $("#sldier-image");         
          owl.owlCarousel({           
          navigation : false, // Show next and prev buttons
          navigationText : ["<img src='img/Gallery/arrow-key.png' alt='image-prev' class='img-responsive nextt' style='transform:rotate(180deg)'>","<img src='img/Gallery/arrow-key.png' alt='img-next' class='img-responsive nextt'>"],
          slideSpeed : 300,
          paginationSpeed : 400,
          items:1,
          singleItem:true,
      ...
      <script>
        ...
        var mndFileds=new Array('Last Name','Mobile','Email');
         ...
         function checkMandatory4415315000004067049() {
         for(i=0;i<mndFileds.length;i++) {
         var fieldObj=document.forms['WebToLeads4415315000004067049'][mndFileds[i]];
         if(fieldObj) {
         ...
         function checkMandatory4415315000004067049(elem) {
        ...
        var email = $("#email");
        var mobile = $("#mobile");
           if(fm_validator(name, email, mobile, 'WebToLeads4415315000004067049')){
            $(elem).attr("disabled", true);
                $('#WebToLeads4415315000004067049').submit();
           }else{
...
f.src = '';
console.log('map loaded after 5s');
}, 5000);
console.log('Started');
      </script> -->
...
<script src="https://cw1.livserv.in?did=8049&amp;pid=1"></script>
 <script> if(typeof wfTRKey=='undefined'){wfTRKey = {};}wfTRKey['url_d2f602bd7b8229d920a508285b1c34a59a17d89857143342f8a53fc1179a5362']='https://crm.zohopublic.com/crm/WebFormAnalyticsServlet?rid=d2f602bd7b8229d920a508285b1c34a59a17d89857143342f8a53fc1179a5362gid4d01b37207b10f83458f8c6a291240f67451bbad6c560f1bf2a3951bf5ceb0bbgid364f49863aa1c6f080988c8e111a90b8gid885e3c1045bd9bdcc91bdf30f82b5696gid14f4ec16431e0686150daa43f3210513';wfTRKey['rs_d2f602bd7b8229d920a508285b1c34a59a17d89857143342f8a53fc1179a5362']=false; function sf(ev){var te = ev.target ? ev.target : ev.srcElement; var nd = te.nodeName ? te.nodeName.toLowerCase() : ''; var fm; if (te.form) { fm = te.form.elements.xmIwtLD.value; } if (fm && !wfTRKey['rs_' + fm] && ((nd == 'input' && te.type != 'file') || (nd == 'input' && te.type == 'file' && ev.type == 'click') || nd == 'select' || nd == 'textarea' || nd == 'div')) { document.getElementById('tr_img_'+fm).setAttribute('src', wfTRKey['url_'+fm]);  wfTRKey['rs_'+fm] = true }} if(document.addEventListener){document.addEventListener('click', sf);document.addEventListener('change', sf);}else{document.attachEvent('onclick', sf);document.attachEvent('onchange', sf);}</script>
   </body>
</html>